...
class AINewsNode:
    ...
    def __init__(self, llm):
        ...
        # Capturing various state information
        self.state = {}
    ...
    def fetch_news(self, state : dict) -> dict:
        ...
        response = self.tavily.search(
            query = "Top Artificaial Intelligence (AI) technology news India and globally",
            topic = "news",
            time_range = time_range_map[frequency],
            include_answer = "advanced",
            max_results = 15,
            days = days_map[frequency],
            # include_domains = ["techcrunch.com", "venturebeat.com/ai", ...] Add domains if required
        )
    ...
    def save_results(self, state):
        '''
        Save the summary results in desired format.
        '''
